...
const initialTasks: Task[] = [
  {
    id: "signals",
    text: "Передать список признаков и весов для определения пользователей, которым показывать B2B коммуникации",
    assigneeId: null,
    time: "4:32",
    done: false,
  },
  ...
  {
    id: "sheet-pricing",
    text: "Создать отдельную Google таблицу для записи данных форм, открываемых через прайсинг и апгрейд, чтобы отделить статистику от баннеров",
    assigneeId: "andryukha",
    time: "17:09",
    done: false,
  },
  ...
  {
    id: "spec-review",
    text: "Санек изучит спецификацию и при необходимости задаст вопросы Андрюхе по технической части",
    assigneeId: "sanek",
    time: "27:11",
    done: false,
  },
