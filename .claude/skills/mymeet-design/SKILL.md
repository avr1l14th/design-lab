...
### Icons
- **Источник — только Heroicons mini pack** (https://heroicons.com/mini). Других иконочных библиотек не использовать.
- **Filled (solid), 16 или 20 px.** Heroicons mini это 20×20 solid; для 16px бери ту же solid-иконку и уменьши до 16. Outline-вариант Heroicons (24×24 stroke) **запрещён**.
...
- ⚠️ **Не использовать outline / stroke иконки** — ни Heroicons outline 24, ни Lucide-style 1-1.5px stroke, ни Phosphor regular. Только solid/filled mini.
...
### Anti-patterns
- ❌ Иконки не из Heroicons mini (Lucide, Phosphor, Material, Feather, и т.д.) — только Heroicons mini solid
- ❌ Outline-иконки любого размера (даже Heroicons 24 outline)
