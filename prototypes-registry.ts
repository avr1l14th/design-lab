...
export const prototypes: Prototype[] = [
  {
    slug: "tags",
    title: "Теги",
    description: "Теги пространства ко встречам: чипы в списке и на встрече, меню тега с переименованием, цветом и удалением, создание из пикера, пункт «Теги» в фильтрах; общие для всех участников без ролей",
    tags: ["tags", "filters", "popover"],
    updatedAt: "2026-09-22",
  },
  {
    slug: "global-chat",
    title: "AI Агент",
    description: "Пункт «AI Агент» с вопросами по всем встречам: стартовая с подсказками, модалка встреч, файлы, диалог с «Думаю…», просмотром встреч и цитатами-источниками, шеринг, закрепление, переименование, удаление, чат внутри встречи",
    tags: ["chat", "ai", "dialogs", "figma"],
