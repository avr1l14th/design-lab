...
export const prototypes: Prototype[] = [
  {
    ...
    description: "Вкладка «Чат» с вопросами по всем встречам: стартовая с режимами и подсказками, модалка встреч, файлы, диалог с «Думаю…», просмотром встреч и цитатами-источниками, шеринг, закрепление, переименование, удаление",
